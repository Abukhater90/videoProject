...
const findUniq = arr => arr.filter((element,index) =>  arr.indexOf(element) === arr.lastIndexOf(element));
  ...
  console.log(findUniq([2,3,2,2,2]));  
...
console.log(toWeirdCase("ali abu khater"));




//5.5
let Name="Ali Abu Khater";
...
console.log(findShortestWord(" best color is blue"));
...
console.log(findLongestWord("My favorite color is red"));
...
//6.2
 ...
 //Counting Duplicates
 let stringforcheck="ali abu khater"
 ...
 console.log(findDuplicates('bb23')) 
...
console.log(organizeStrings('aaaaaaaaaaa','bbbbb')) 
...
console.log(findDuplicates(stringforcheck)) 
console.log(findDuplicates('1234')) 
